...
\dedicatory{A mi familia y amigos\ldots}
...
\input{./Chapter2_data/chapter2.tex} % Description of the HLIRG sample

\input{./Chapter3_methods/chapter3.tex} % X-ray XMM study


\input{./Chapter4_xsh/chapter4.tex} % Study of the Spectral Energy Distributions

\input{./Chapter5_buxs/chapter5.tex} % MIR Spitzer study
