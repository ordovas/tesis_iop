...
\addtocontents{toc}{\vspace{1em}}  % Add a gap in the Contents, for aesthetics
	 ...
	 \large{\textbf{\tutorname}, \degreenameb,} 
	  ...
	  \vspace{2.5cm}
	  \large{En Santander, a 11 de Septiembre de 2058}\par % \\ \\ \\
          \bigskip
          \bigskip
          \bigskip
...
\dedicatory{Ph'nglui mglw'nafh Cthulhu R'lyeh wgah'nagl fhtagn\ldots}
...
\input{./Chapter1_intro/chapter1.tex} % Introduction

\input{./Chapter2_data/chapter2.tex} % Instrumentation and data origin

\input{./Chapter3_methods/chapter3.tex} % The BUXS sample and methods


\input{./Chapter4_xsh/chapter4.tex} % Xshooter 2 objectss

\input{./Chapter5_buxs/chapter5.tex} % Type-1 BUXS sample

\input{./Chapter6_conc/chapter6.tex} % Conclusions and future work
...
\input{./Appendices/AppendixA.tex}	% Appendix Title
